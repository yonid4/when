...
//   useEffect(() => {
//     console.log("Backend URL:", process.env.NEXT_PUBLIC_BACKEND_URL);
//     fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/`).then((response) => {
//       if (!response.ok) {
...
//   // // hardcoding startDate and endDate to display wanted calendar
//   // useEffect(() => {
//   //   console.log(event);
//   //   setEvent ({
...
//   let calendar = displayCalendar(viewType)
...
// function displayCalendar(viewType){
//   let calendar;
//   let calendarEl;
//   // const calendarEl = document.getElementById("calendar");
